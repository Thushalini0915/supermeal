    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <div className="hidden sm:flex flex-1 max-w-2xl mx-4">
          <div className="flex w-full rounded-md overflow-hidden border border-gray-300 focus-within:border-green-600 focus-within:ring-1 focus-within:ring-green-600">
        ...
        <div className="flex items-center gap-4 md:gap-6 flex-shrink-0">
          <div className="hidden lg:flex flex-col items-end">
            <span className="text-[11px] text-gray-500 uppercase tracking-wide">Happiness Hotline</span>
          ...
          <Link to="/cart" className="relative flex flex-col items-center text-gray-600 hover:text-green-700 transition-colors">
            ...
            <span className="absolute -top-1.5 -right-2 bg-green-600 text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center">0</span>
          </Link>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center overflow-x-auto scrollbar-none">
            ...
            <div className="relative group flex-shrink-0">
              <button className="flex items-center gap-2 bg-green-800 hover:bg-green-900 text-white px-4 py-3 text-sm font-semibold transition-colors">
            ...
            <Link to="/order-status" className="flex-shrink-0 ml-auto">
              <span className="inline-block bg-white text-green-700 hover:bg-green-50 px-4 py-1.5 text-sm font-semibold rounded-full whitespace-nowrap transition-colors">
                Order Status
              </span>
            </Link>
          </div>
